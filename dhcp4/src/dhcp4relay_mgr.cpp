 ...
 * notifications by invoking the handleSwssNotification method. It also sets the stopThread
 ...
 *
 * The function continues to run until the `stopThread` flag is set. For each notification,
